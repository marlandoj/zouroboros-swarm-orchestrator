...
**Multi-agent orchestration engine for [Zo Computer](https://zo.computer) — spawn parallel agent teams with token-optimized memory, DAG task dependencies, and resilient execution.**
